  ...
  var ServerSideFilter = Backgrid.Extension.ServerSideFilter = Backbone.View.extend({
    ...
    */
    search: function (e) {
      ...
      var data = {};
      data[this.name] = this.searchBox().val();
  ...
  var ClientSideFilter = Backgrid.Extension.ClientSideFilter = ServerSideFilter.extend({
    ...
    */
    initialize: function (options) {
      ...
      this.listenTo(collection, "sort reset", function (col, options) {
        options = _.extend({reindex: true}, options || {});
        if (options.reindex && col === collection && options.from == null && options.to == null) {
